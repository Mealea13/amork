...
class SnackView extends StatelessWidget {
  ...
  SnackView({super.key, required this.onAddToCart});
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Stack(
                          ...
                          children: [
                            Padding(padding: const EdgeInsets.symmetric(vertical: 8.0), child: Image.asset(food.imageUrl, fit: BoxFit.contain, errorBuilder: (c,e,s) => const Icon(Icons.cookie, size: 50, color: Colors.grey))),
                            if (food.originalPrice != null)
